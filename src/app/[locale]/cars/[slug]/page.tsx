...
import { CheckCircle2, Fuel, Gauge, Settings, ShieldCheck, Zap } from "lucide-react";
            ...
            <aside className="h-fit rounded-md border theme-surface p-7">
              <div className="flex flex-wrap gap-1.5 items-center">
                ...
                <Badge tone={car.status}>
                  {car.status === "available" ? t("availableBadge") : car.status === "reserved" ? t("reservedBadge") : t("soldBadge")}
                </Badge>
              </div>
