        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_350px]">
            ...
            <aside className="space-y-8">
              ...
              {/* Sidebar Banner Ad */}
              <div className="relative overflow-hidden rounded-md border theme-border theme-surface-strong p-6 text-center">
                <div className="absolute inset-0 bg-gradient-to-t from-[#080c11] via-[#080c11]/80 to-transparent z-10" />
                <Image
                ...
                <div className="relative z-20 space-y-4">
                  <h4 className="font-display text-lg font-bold text-[var(--foreground)]">Bạn đang tìm mua xe chất lượng?</h4>
                  <p className="text-xs theme-subtle">Khám phá kho xe đã kiểm định của chúng tôi và đặt lịch lái thử ngay hôm nay.</p>
