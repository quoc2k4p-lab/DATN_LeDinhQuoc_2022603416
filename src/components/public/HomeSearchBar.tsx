...
export function HomeSearchBar() {
  ...
  return (
    <form onSubmit={handleSearch} className="flex gap-3 rounded-md border theme-surface p-4 shadow-2xl shadow-black/20">
      ...
      <button
        type="submit"
        className="flex items-center justify-center gap-2 rounded-md bg-[#e31837] px-6 text-sm font-bold uppercase tracking-[0.05em] text-white hover:bg-[#c1122b] transition duration-200"
      >
        Tìm kiếm
      </button>
    </form>
