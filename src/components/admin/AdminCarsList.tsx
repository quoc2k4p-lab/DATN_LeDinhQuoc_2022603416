...
import { Edit3, EyeOff, Trash2, Loader2, AlertCircle, CheckCircle2 } from "lucide-react";
              ...
              <tr key={car.id} className="border-t border-white/8 hover:bg-white/1 transition-colors">
                ...
                <td className="px-5 py-4">
                  <div className="flex flex-wrap gap-1.5 items-center">
                    ...
                    <Badge tone={car.status}>
                      {car.status === "available" ? "CÒN XE" : car.status === "reserved" ? "ĐANG GIỮ CHỖ" : "ĐÃ BÁN"}
                    </Badge>
                  </div>
                </td>
                <td className="px-5 py-4">
                  <div className="flex gap-2">
                    ...
                    <button 
                      className="rounded-md border border-white/10 p-2 text-zinc-300 hover:bg-white/5 transition"
                      title="Tạm ẩn"
                    >
                      <EyeOff size={16} />
                    </button>
