...
export default function MyAccountPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-lg border theme-border theme-surface p-6 shadow-md">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 pb-6 mb-6 border-b theme-border">
          <div className="relative group">
            {profileData.avatar ? (
              ...
              <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[var(--muted)] text-3xl font-bold text-[#e31837] border-2 border-dashed border-[#e31837]/35">
      ...
      <section 
        ...
        className="rounded-lg border theme-border theme-surface p-6 shadow-md"
      >
        <div className="flex items-center gap-3 border-b theme-border pb-4 mb-6">
