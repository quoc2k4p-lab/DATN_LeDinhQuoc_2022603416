        ...
        <section className="mx-auto grid max-w-7xl gap-8 px-5 py-14 sm:px-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xl leading-7 theme-subtle">
              Gửi yêu cầu tư vấn nhanh chóng tới đội ngũ của chúng tôi.
            </p>
            <div className="mt-8 space-y-4 text-sm theme-subtle">
              <p className="flex items-center gap-3"><MapPin size={18} /> Nguyên Xá, Tây Tựu, Hà Nội</p>
              <p className="flex items-center gap-3"><Phone size={18} /> 0348 115 938</p>
