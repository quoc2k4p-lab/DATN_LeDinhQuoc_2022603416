    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Nếu Anh/Chị cần thay đổi lịch hẹn hoặc có bất kỳ câu hỏi nào, vui lòng liên hệ trực tiếp với chúng tôi qua hotline hỗ trợ chăm sóc khách hàng hoặc phản hồi lại email này.</p>
        ...
        <div class="footer">
          <p><strong>Hệ thống Showroom Ô tô Đã qua sử dụng TQ Auto</strong></p>
