    ...
    <div className="overflow-hidden rounded-md border border-white/10 bg-[#151a22]">
      <div className="flex items-center justify-between border-b border-white/10 p-5">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">Dữ liệu mẫu cho UI, chưa kết nối backend.</p>
        </div>
                ...
                <td className="px-5 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-semibold uppercase tracking-[0.08em] text-zinc-500">{car.id}</p>
                    </div>
                  </div>
                </td>
