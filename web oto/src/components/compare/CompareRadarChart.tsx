  ...
  if (cars.length === 0) {
    return (
      <div className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-5 sm:p-6 lg:p-8 shadow-xl flex flex-col justify-between min-h-[440px]">
        ...
        <div className="flex flex-col items-center justify-center flex-1 my-8 border border-dashed border-[var(--line)] rounded-xl p-6 text-center bg-[var(--background)]/[0.02]">
          ...
          <p className="text-sm font-semibold text-[var(--foreground)]">Chưa có dữ liệu biểu đồ</p>
          <p className="text-xs text-[var(--subtle)] mt-1 max-w-[250px]">Vui lòng thêm xe để hiển thị biểu đồ so sánh 5 khía cạnh</p>
        </div>
      </div>
    );
  }
