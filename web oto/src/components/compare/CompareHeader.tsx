          ...
          {Array.from({ length: 3 }).map((_, index) => {
            ...
            if (car) {
              return (
                <div
                  key={car.id}
                  className="w-[280px] bg-[var(--surface)] border border-[var(--line)] rounded-xl p-4 relative group shadow-lg flex flex-col justify-between"
                >
                  <div className="relative">
                    ...
                    {/* Thumbnail */}
                    <div className="relative aspect-[16/10] w-[80%] overflow-hidden rounded-lg bg-[var(--muted)] shadow-inner">
                      <img
                        src={car.image}
                        alt={car.name}
              ...
              return (
                <div
                  ...
                  className="w-[280px] border border-dashed border-[var(--line)] bg-[var(--surface)]/50 rounded-xl p-6 flex flex-col items-center justify-center text-center min-h-[280px]"
                >
                  <button
                    type="button"
                    onClick={() => setIsModalOpen(true)}
                    className="flex h-11 w-11 items-center justify-center rounded-full bg-[#e31837]/10 text-[#e31837] hover:bg-[#e31837] hover:text-white transition duration-300 shadow-md shadow-[#e31837]/10 cursor-pointer"
                  >
                    <Plus size={20} />
                  </button>
          ...
          <div className="relative w-full max-w-xl transform overflow-hidden rounded-xl border border-[var(--line)] bg-[var(--surface)] text-[var(--foreground)] p-5 sm:p-6 shadow-2xl transition-all backdrop-blur-md flex flex-col max-h-[90vh]">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full rounded-lg border border-[var(--line)] bg-[var(--background)] py-2.5 pl-10 pr-4 text-sm font-semibold placeholder:text-[var(--subtle)] placeholder:font-medium focus:border-[#e31837] focus:outline-none focus:ring-1 focus:ring-[#e31837]"
              />
            </div>
