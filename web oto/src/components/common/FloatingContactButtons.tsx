...
export function FloatingContactButtons() {
  ...
  return (
    <>
      {!isAnyChatOpen && (
        <div
          className="fixed z-[9999] flex flex-col gap-3 right-[12px] bottom-[90px] md:right-[20px] md:bottom-[100px]"
          style={{ zIndex: 9999 }}
        >
          ...
          {showScrollTop && (
            <button
              ...
              className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-zinc-800 text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-zinc-700 focus:outline-none"
          ...
          <a
            href="tel:0348115938"
            className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-emerald-600 text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-emerald-500 focus:outline-none"
          ...
          <button
            ...
            className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#e31837] text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-[#c1132a] focus:outline-none"
            aria-label="Trò chuyện với AI"
          >
            <Sparkles size={22} />
            <span className="absolute -top-1.5 -right-1 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-emerald-500 text-[8px] font-bold border border-[#0d1016]">
              AI
            </span>
          ...
          <button
            ...
            className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-blue-600 text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-blue-500 focus:outline-none"
