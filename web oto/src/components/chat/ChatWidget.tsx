      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-0 right-0 z-50 w-full h-full sm:bottom-20 sm:right-6 sm:w-[380px] sm:h-[530px] flex flex-col rounded-t-2xl sm:rounded-2xl border border-white/10 bg-[#121620]/95 shadow-2xl backdrop-blur-md overflow-hidden"
          >
            {/* Header */}
