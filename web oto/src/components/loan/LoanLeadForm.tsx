            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  {...register("fullName")}
                  className={`w-full rounded-lg border bg-background px-4 py-2.5 text-base sm:text-sm text-foreground placeholder-subtle/50 focus:outline-none transition-colors ${
