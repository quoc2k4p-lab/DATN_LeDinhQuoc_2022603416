            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              {!initialCar && cars.length > 0 && (
                <div className="sm:col-span-2">
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-line bg-background px-4 py-2.5 text-base sm:text-sm text-foreground focus:border-[#e31837] focus:outline-none transition-colors"
                  >
                    {cars.map((car) => (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-line bg-background px-4 py-2 text-base sm:text-sm text-foreground focus:border-[#e31837] focus:outline-none transition-colors font-semibold"
                />
              </div>
