...
export function FormField({
  ...
  const inputClass = cn(
    "w-full rounded-md border bg-[var(--background)] px-4 text-sm text-[var(--foreground)] outline-none transition placeholder:text-[var(--subtle)] disabled:opacity-50 disabled:cursor-not-allowed",
    error 
