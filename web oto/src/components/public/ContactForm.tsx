...
export function ContactForm() {
  ...
  if (success) {
    return (
      <div className="rounded-md border border-emerald-500/20 bg-emerald-500/5 p-8 text-center shadow-lg animate-fadeIn">
        ...
        <h3 className="font-display text-xl font-bold text-[var(--foreground)] mb-2">Gửi yêu cầu thành công</h3>
        <p className="text-sm theme-subtle leading-relaxed mb-6">
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-md border theme-surface p-6 shadow-md transition duration-300 hover:border-red-600/20">
      {submitError && (
